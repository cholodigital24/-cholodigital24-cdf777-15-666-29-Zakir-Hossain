...
const SocialLinks = [
  {
    ...
    to: "https://www.facebook.com/hmzakir007",
  },
  {
    title: "Twitter",
    icons: <FaTwitter className="text-white" />,
    to: "https://twitter.com/hmzak007", // Replace with your actual link
  },
  {
    title: "Instagram",
    icons: <FaInstagram className="text-white" />,
    to: "https://www.instagram.com/hmzakir007", // Replace with your actual link
  },
  {
    title: "TikTok",
    icons: <FaTiktok className="text-white" />,
    to: "https://www.tiktok.com/@mdzakirhossain0478", // Replace with your actual link
  },
  {
    title: "YouTube",
    icons: <FaYoutube className="text-white" />,
    to: "https://www.youtube.com/@hmZakir", // Replace with your actual link
  },
];
